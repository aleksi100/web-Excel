let current
const cellStyles = 'cell bg-gray-200 border-black border h-8 w-20 '
const Letters = ' ABCDEFGHIJKLMNOPQRSTUW'
let Cells = {}
  ...
  if (y === 0) {
    ...
    cell.addEventListener('input', (value) => {
      if (value.target.value[0] === '=') {
        isChoice = true
        main.classList.add('cell')
      } else {
        isChoice = false
        main.classList.remove('cell')
      }
    })
